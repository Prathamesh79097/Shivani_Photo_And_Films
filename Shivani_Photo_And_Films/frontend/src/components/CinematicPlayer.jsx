...
const CinematicPlayer = ({ items }) => {
    ...
    return (
        <div className="w-full relative rounded-2xl overflow-hidden glass-panel shadow-2xl border border-white/10 group">
            ...
            <div className="absolute top-4 left-4 z-20 px-4 py-2 bg-white/5 backdrop-blur-md rounded-lg border border-white/10 text-xs tracking-widest text-white/80 uppercase">
